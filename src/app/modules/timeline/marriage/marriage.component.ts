...
export class MarriageComponent implements OnInit {
    ...
    this.getData().subscribe(data => {
      ...
      imagesData.map((image, index) => {
        this.images.push(new Image(
          index,
          { // modal
            img: '/assets/images/timeline/marriage/' + image.img,
            description: image.description,
            title: image.title
          }
        ));
        this.galleryImages.push({
          small: '/assets/images/timeline/marriage/' + image.img,
          medium: '/assets/images/timeline/marriage/' + image.img,
          big: '/assets/images/timeline/marriage/' + image.img,
          description: image.description
        });
      });
  ...
  private getData() {
    return Observable.forkJoin(
      this.imagesService.getMarriageImages(),
    );
  }
